export const experiences = [
  {
    ...
    technologies: ["Figma", "UI/UX Design", "User Research", "Prototyping", "Design Systems"],
...
export const achievements = [
  {
    ...
    description: "Completed 100 consecutive days of coding, focusing on advanced React patterns, Framer Motion, and full-stack development.",
    date: "2024"
  },
  {
    title: "Hackathon Finalist",
    category: "Competition",
    description: "Developed an AI-powered educational tool that reached the finals of the university-level hackathon.",
    date: "2024"
  },
  {
    title: "UI/UX Design Certification",
    category: "Certification",
    description: "Completed an advanced course in User Interface and User Experience design principles.",
    date: "2025"
  },
  {
    title: "LeetCode 200+",
    category: "Problem Solving",
    description: "Solved over 200 algorithmic problems spanning dynamic programming, graphs, and data structures.",
    date: "Ongoing"
  }
];
