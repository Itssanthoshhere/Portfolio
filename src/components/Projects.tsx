...
// const projects = [
//   // ── TIER 1: Flagship Full-Stack Web Apps ──────────────────────────────────
...
//   {
//     title: "WaveChat 🌊 – Cross-Platform Real-Time Messaging App",
//     description:
//       "A production-grade full-stack messaging platform built with React 19, React Native (Expo), Express.js, MongoDB, and Socket.io. Works seamlessly across iOS, Android, and web with typing indicators, online presence, and optimistic UI.",
//     longDescription:
//       "WaveChat is a full-stack, cross-platform messaging application powered by a custom Socket.io server — giving full control over real-time infrastructure with no vendor lock-in. Built with React 19 + Vite for web and React Native (Expo) for mobile, it shares a single Node.js/Express backend backed by MongoDB. Features include real-time messaging, typing indicators, online/offline presence, message persistence, optimistic UI updates, user search, and OAuth authentication via Clerk. The architecture is fully typed with TypeScript and monitored with Sentry.",
//     video: wavechatPreview, // add your preview asset
//     image: wavechatThumbnail, // add your thumbnail asset
//     technologies: [
//       "React 19",
//       "React Native (Expo)",
//       "TypeScript",
...
//       "OAuth authentication (Google, Apple) via Clerk",
//       "Message history and persistence with MongoDB",
//       "User search and discovery",
//       "Fully typed with TypeScript end-to-end",
//     ],
//     githubUrl: "https://github.com/Itssanthoshhere/WaveChat-App",
//     liveUrl: "https://wavechat-app.onrender.com/", // add if deployed
//     duration: "April 2026",
//     category: "Full-Stack Mobile & Web App",
//   },

//   // ── TIER 2: Full-Stack Mobile Apps (React Native) ─────────────────────────
...
//   // ── TIER 3: Real-Time / Collaborative Apps ────────────────────────────────
...
//   // ── TIER 5: Advanced Animated / Interactive Frontend ──────────────────────
...
//   // ── TIER 6: Frontend Web Apps & Landing Pages ─────────────────────────────
...
function SectionDivider({ number, title, subtitle }) {
  return (
    <div className="flex items-start gap-6 mt-24 mb-12">
      ...
      <div className="border-l-2 border-accent/40 pl-6 pt-1">
...
function ProjectCard({ project }) {
  return (
    <Card className="card-project overflow-hidden animate-slide-up">
      <div className="grid lg:grid-cols-2 gap-0">
        {/* Media */}
        <div className="relative overflow-hidden">
          {project.video && project.video !== "" ? (
...
const flagshipProjects = [
  ...
  },
  {
    ...
    description:
      "An AI-driven Learning Management System built with Next.js, Supabase, Clerk, and Vapi. Enables real-time voice-based learning, subscriptions, bookmarks, and session tracking.",
    longDescription:
      "Converso is a modern, full-stack SaaS Learning Management System designed to transform how users learn through real-time AI voice conversations. Built with Next.js App Router and TypeScript, it integrates Supabase for PostgreSQL-backed data handling, Clerk for authentication and subscription management, Stripe for billing, and Vapi AI for low-latency speech-to-speech tutoring. Users can create personalized AI companions, talk to them via voice, bookmark favorites, track learning history, and unlock premium features through subscriptions.",
    video: conversoPreview,
    image: conversoThumbnail,
    technologies: [
      "Next.js (App Router)",
...
const mobileProjects = [
  ...
  },
  {
    ...
    description:
      "A ride-booking mobile app built with React Native, Expo, Stripe, Google Maps, and PostgreSQL. Offers a smooth Uber-like experience with real-time tracking, secure payments, and user-friendly design.",
    longDescription:
      "Rdye is a full-featured ride-booking application that replicates the Uber experience using a modern tech stack. Built with React Native and Expo, it includes real-time map tracking, Stripe-based payments, secure authentication with Clerk, and PostgreSQL database hosted via NeonDB. It's crafted with clean UI using NativeWind (Tailwind CSS for React Native) and offers an end-to-end cab booking experience on both Android and iOS devices.",
    video: rdyepreview,
    technologies: [
      "React Native",
      "Expo",
  ...
  },
  {
    title: "🍔 Food Delivery Mobile App",
    description:
      "A modern, full-stack food delivery app built with React Native, Expo, TailwindCSS (NativeWind), Appwrite, and TypeScript. Features smooth UI, Google authentication, dynamic search, and cart functionality.",
    longDescription:
      "The Food Delivery Mobile App is a full-stack application designed to deliver a smooth, intuitive, and modern food-ordering experience. Built with React Native and Expo, styled using NativeWind (Tailwind CSS for React Native), and powered by TypeScript, it integrates Appwrite for secure authentication, database management, and file storage. The app features Google sign-in, category-based search and filtering, cart and checkout functionalities, and a responsive UI optimized for both Android and iOS.",
    video: foodreview,
    technologies: [
      "React Native",
      "Expo",
  ...
  },
  {
    ...
    description:
      "A modern cross-platform real estate app built with React Native, Expo, Appwrite, and Tailwind CSS. Designed for browsing, searching, and managing property listings with an intuitive, mobile-first UI.",
    longDescription:
      "Real Scout is a full-stack mobile application designed for discovering and managing property listings effortlessly. Built with React Native and Expo SDK 52, it integrates Appwrite for authentication, database, and file storage, while NativeWind (Tailwind CSS for React Native) ensures a clean and responsive design. Users can explore properties, apply filters, view detailed property information, save favorites, and manage their profiles.",
    video: restate,
    technologies: [
      "React Native",
      "Expo SDK 52",
...
const realtimeProjects = [
  ...
  },
  {
    title: "🛍️ Nike E-commerce w/ Devin AI",
    description:
      "A full-stack modern eCommerce app featuring product pages, cart & checkout with Stripe, authentication, PostgreSQL/Drizzle ORM backend, Zustand state management, and a clean Tailwind UI. Built collaboratively with Devin AI.",
    longDescription:
      "Nike-style E-commerce is a full-stack modern shopping platform built with Next.js 15, TypeScript, and TailwindCSS, featuring a PostgreSQL backend via NeonDB with Drizzle ORM, and secure authentication powered by Better Auth. State management is handled with Zustand, while Stripe ensures smooth checkout flows. Designed with a clean and modular UI, the project was built step by step using Devin AI for AI-assisted development.",
    video: nikePreview,
    image: nikeThumbnail,
    technologies: [
      "Next.js 15",
...
const threeDProjects = [
  ...
  },
  {
    title: "🛹 Suburbia Skate – Interactive 3D Skateboard Website",
    description:
      "A modern, interactive skateboard website with 3D animations using Next.js 15, TailwindCSS, Prismic CMS, and React Three Fiber. Built with Slice Machine and GSAP for smooth animations.",
    longDescription:
      "Suburbia Skate is an interactive skateboard website showcasing products and 3D experiences using React Three Fiber. Users can explore products, view 3D skateboards, and interact with animations powered by GSAP. The site is powered by Next.js 15, TailwindCSS, and Prismic CMS for easy content management, featuring modular components, smooth animations, and fully responsive design.",
    video: suburbiaPreview,
    image: suburbiaThumbnail,
  ...
  },
  {
    ...
    description:
      "Interactive 3D soda can animation website built with React Three Fiber, Next.js App Router, and Prismic CMS. A fun, fizzy, and fully responsive splash experience for products or portfolios.",
    longDescription:
      "Fizzi 🥤 is a visually immersive 3D soda can experience built with React Three Fiber and powered by Prismic CMS. Designed as a creative product splash or personal branding demo, it features animated UI, custom SVGs, and CMS-editable content. Leveraging Next.js App Router, the site delivers seamless routing, responsiveness, and performance.",
    video: fizzi,
    image: fizziThumbnail,
    technologies: [
      "React Three Fiber",
...
const animatedProjects = [
  {
    ...
    description:
      "A scroll-driven, animated cocktail website built with React, GSAP, and Tailwind CSS. Features SplitText reveals, ScrollTrigger timelines, pinned sections, parallax scrolling, scroll-synced videos, image masking, and custom carousels.",
    longDescription:
      "Velvet Pour is a modern, interactive cocktail website built with React, GSAP, and Tailwind CSS. The project leverages advanced scroll-driven animations like SplitText reveals, ScrollTrigger timelines, pinned sections, parallax scrolling, scroll-synced video playback, image masking, and a fully customized carousel. Designed with responsive layouts and modular React components, it delivers a polished, cinematic, and immersive user experience.",
    video: velvetPourPreview,
    image: velvetThumbnail,
    technologies: [
      "React",
  ...
  },
  {
    ...
    description:
      "A modern and fully responsive creative agency clone built with React, GSAP, TailwindCSS, and Vite. Features immersive animations, video backgrounds, and storytelling-inspired layouts.",
    longDescription:
      "K72 Clone is a sleek and animated web project inspired by the K72 Creative Agency website. It showcases smooth GSAP-powered animations, autoplay video backgrounds, bold typography, and a clean, minimal aesthetic. Built with React, TailwindCSS, and Vite, it delivers an immersive user experience and highlights modern web animation techniques.",
    video: k72Preview,
    image: k72Thumbnail,
    technologies: ["React", "GSAP", "TailwindCSS", "Vite"],
    features: [
  ...
  },
  {
    title: "Magma 🔥 – Interactive Web3 Real Estate Landing Page",
    description:
      "A sleek, modern landing page with 14 scrollable sections, animated hero, dynamic visuals, scroll-triggered effects built using HTML, CSS, JavaScript, GSAP, and Locomotive Scroll.",
    longDescription:
  ...
  },
  {
    title: "Rayve 🕶️ – Animated Modern Landing Page",
    description:
      "A sleek and interactive landing page with animated text, dynamic backgrounds, and smooth visual effects using HTML, CSS, JavaScript, GSAP, and Shery.js.",
    longDescription:
      "Rayve is a visually engaging landing page project that combines interactive hero sections, dynamic backgrounds, and smooth animations using GSAP and Shery.js. It offers immersive effects, responsive design for all devices, and a modern aesthetic suitable for showcasing products, portfolios, or digital experiences.",
    video: rayvePreview,
    image: rayveThumbnail,
    technologies: ["HTML5", "CSS3", "JavaScript", "GSAP", "Shery.js"],
    features: [
...
const frontendProjects = [
  ...
  },
  {
    title: "🌶️ Spicy Picy – Landing Page",
    description:
      "A modern and responsive landing page for a spice brand, built with React, Tailwind CSS, and Vite. Features Hero, Banner, Products, About, Reviews, and Footer sections.",
    longDescription:
      "Spicy Picy is a visually appealing, fully responsive landing page designed for a spice brand. Built with React and Tailwind CSS, it showcases products, highlights brand specialties, displays customer reviews, and provides a smooth scrolling experience.",
    video: spicyPreview,
    image: spicyThumbnail,
    technologies: ["React", "Tailwind CSS", "Vite", "JavaScript (ES6)"],
    features: [
  ...
  },
  {
    ...
    description:
      "A responsive multi-page fitness website built with HTML, CSS, and JavaScript, featuring dynamic navigation, smooth UI interactions, Swiper.js carousels, and mobile-first design.",
    longDescription:
      "Flex Haven is a modern, responsive gym & fitness website designed to provide a professional online presence for fitness enthusiasts, trainers, and gyms. Built with HTML5, CSS3, and JavaScript, it includes dynamic navigation, Swiper.js carousels, a contact form, and interactive elements.",
    video: flexHavenPreview,
    image: flexThumbnail,
    technologies: ["HTML5", "CSS3", "JavaScript", "Swiper.js"],
    features: [
  ...
  },
  {
    ...
    description:
      "A modern and fully responsive eCommerce landing page built with HTML, Tailwind CSS, and vanilla JavaScript. Features product showcase, blog section, smooth interactions, and deployment on Vercel.",
    longDescription:
      "CozyNest is a stylish and responsive eCommerce landing page created to showcase handmade decor. Built with HTML5, Tailwind CSS, and vanilla JavaScript, it demonstrates modern UI/UX principles with smooth interactions and responsive design.",
    video: cozynestPreview,
    image: cozynestThumbnail,
    technologies: ["HTML5", "Tailwind CSS", "JavaScript (ES6)", "Vercel"],
    features: [
      ...
      "Blog section highlighting handmade decor insights",
      "Parallax background effects for immersive visuals",
      "Custom image slider with auto-slide functionality",
    ],
    githubUrl: "https://github.com/Itssanthoshhere/CozyNest-ecommerce",
    liveUrl: "https://cozynest-ecommerce.vercel.app/",
    duration: "September 2025",
  ...
  },
  {
    title: "☕ Pastry World – Modern Café & Bakery Website",
    description:
      "A stylish and responsive café & bakery website built with HTML, CSS, and JavaScript. Features interactive menu cards, booking form, smooth animations, and a mobile-first design.",
    longDescription:
      "Pastry World is a modern, fully responsive café and bakery website designed with HTML5, CSS3, and JavaScript. It provides an elegant online presence for bakeries, coffee shops, and dessert cafés, with interactive features like menu cards, booking forms, and scroll-based animations.",
    video: pastryPreview,
    image: pastryThumbnail,
    technologies: [
      "HTML5",
...
const sections = [
  {
    ...
    subtitle:
      "Production-grade apps with auth, payments, real-time features, and live deployments",
  ...
  },
  {
    ...
    subtitle:
      "Cross-platform iOS & Android apps built with Expo and backed by scalable APIs",
  ...
  },
  {
    ...
    subtitle:
      "Socket.io, live sync, multiplayer, and multi-user collaboration experiences",
  ...
  },
  {
    ...
    subtitle:
      "Immersive Three.js & React Three Fiber projects with CMS-driven content",
  ...
  },
  {
    ...
    subtitle:
      "GSAP-powered interactive websites with scroll-driven storytelling",
  ...
  },
  {
    ...
    subtitle:
      "Responsive UI projects showcasing component design, layout, and polish",
    ...
    <section id="projects" className="section-padding bg-surface/30">
      <div className="container-custom">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A showcase of my work across full-stack web, React Native mobile,
            real-time systems, 3D experiences, and motion design — organized by
            discipline.
          </p>
        </div>

        {/* Sectioned Project Groups */}
